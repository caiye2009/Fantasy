...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/application.CreateOrderRequestV2"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "创建成功",
                        "schema": {
                            "$ref": "#/definitions/application.OrderDetailResponse"
                        }
                    },
                    "400": {
                        "description": "请求参数错误",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "获取成功",
                        "schema": {
                            "$ref": "#/definitions/application.OrderListDetailResponse"
                        }
                    },
                    "500": {
                        "description": "服务器错误",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/application.AssignDepartmentRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/application.AssignPersonnelRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/application.AddDefectRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/application.EventResponse"
                            }
                        }
                    },
                    "500": {
        ...
        "/order/{id}/progress/fabric-input": {
            "post": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/application.UpdateProgressRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/order/{id}/progress/warehouse-check": {
            "post": {
                "security": [
                    {
                        "Bearer": []
    ...
    "definitions": {
        ...
        "application.AssignDepartmentRequest": {
            "type": "object",
            "required": [
                "department"
            ],
        ...
        "application.AssignPersonnelRequest": {
            "type": "object",
            "required": [
                "fabric_target_quantity",
                "order_coordinator_id",
                "production_specialist_id"
            ],
            "properties": {
                "fabric_target_quantity": {
                    "description": "胚布目标数量",
        ...
        "application.CreateOrderRequestV2": {
            "type": "object",
            "required": [
                "client_id",
                "order_no",
        ...
        "application.OrderDetailResponse": {
            "type": "object",
            "properties": {
                "assigned_department": {
                    "type": "string"
                ...
                "progress_items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/application.ProgressResponse"
                    }
                },
                "required_quantity": {
                    "type": "number"
        ...
        "application.OrderListDetailResponse": {
            "type": "object",
            "properties": {
                "orders": {
                    "type": "array",
        ...
        "application.UpdateProgressRequest": {
            "type": "object",
            "required": [
                "quantity"
            ],
